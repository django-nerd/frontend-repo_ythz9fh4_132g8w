...
export default function Hero({ theme }) {
  ...
  useEffect(() => {
    // Subtle gradient shimmer on mount
        ...
        <div className="mx-auto w-full max-w-6xl px-6">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href="#contact" className="group inline-flex items-center gap-2 rounded-full bg-black px-5 py-3 text-white transition-colors hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90">
                Start a project
